...
Character * Character::create(const char* name ,Vec2 pos)
{
...
Character * Character::clone(Vec3 pos)
{
	auto clone = Character::create();
...
void Character::Init(const char* name, Vec2 pos)
{
	char str[50] = { 0 };
